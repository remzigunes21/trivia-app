...
__Timer - User has 15 seconds to answer the question, if user does not answer the question in given time, user should be directed to a page which states that time's up.
__Point system - User earns points with respect to remaining time.
